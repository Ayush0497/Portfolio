    ...
    public void LoadGame()
    {
        ...
        if (File.Exists(path))
        {
            ...
            using (FileStream stream = new FileStream(path, FileMode.Open))
            {
                ...
                Level = data.Level;
                hasMetNPC = data.hasMetNPC;
                hasMetNPC2 = data.hasMetNPC2;
                hasMetNPC3 = data.hasMetNPC3;
                PowerUp1Collected = data.PowerUp1Collected;
                PowerUp2Collected = data.PowerUp2Collected;
